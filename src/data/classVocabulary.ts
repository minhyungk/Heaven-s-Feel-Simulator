...
export const CLASS_VOCABULARY: Partial<Record<ServantClass, ClassVocab>> = {
  Saber: { weapon: "검", weaponAlt: "성검", verb: "베다", verbAlt: "내려치다", style: "검술" },
  Archer: { weapon: "화살", weaponAlt: "투사체", verb: "쏘다", verbAlt: "관통하다", style: "사격" },
  Lancer: { weapon: "창", weaponAlt: "장창", verb: "찌르다", verbAlt: "스쳐지나가다", style: "창술" },
  Rider: { weapon: "전차", weaponAlt: "탈것", verb: "돌진하다", verbAlt: "질주하다", style: "기승" },
  Caster: { weapon: "마술", weaponAlt: "주문", verb: "전개하다", verbAlt: "발동하다", style: "마술" },
