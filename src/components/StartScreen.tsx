  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
        <div className="animate-spin-slow w-[600px] h-[600px] opacity-10">
      ...
      >
        ...
        <p className="text-xl text-gray-400 mb-2">성배전쟁 시뮬레이터</p>
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.95 }}
        onClick={onStart}
        className="z-10 px-12 py-4 text-xl font-bold rounded-lg border-2 border-gold bg-transparent text-gold cursor-pointer transition-all hover:bg-gold/10"
